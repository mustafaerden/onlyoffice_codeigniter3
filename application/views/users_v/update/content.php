<div class="row">
    <div class="page-header">
        <div class="d-flex align-items-center">
            <h2 class="page-header-title">Update <?php echo $user->name . ' ' . $user->last_name; ?>' s User Info</h2>
        </div>
    </div>
</div>
    ...
    <div class="col-12">
        ...
        <div class="widget has-shadow">
            <div class="widget-body">
                <form class="form-horizontal" method="post" action="<?php echo base_url("users/update/$user->id"); ?>">
                    <div class="form-group row d-flex align-items-center mb-5">
                        <label class="col-lg-3 form-control-label">Username *</label>
                        <div class="col-lg-9">
                            <input type="text" name="username" placeholder="Enter Username" class="form-control" value="<?php echo $user->username; ?>">
                    ...
                    <div class="form-group row d-flex align-items-center mb-5">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="name" placeholder="Enter First Name" class="form-control" value="<?php echo $user->name; ?>">
                            <?php if (isset($form_error)): ?>
                    ...
                    <div class="form-group row d-flex align-items-center mb-5">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="last_name" placeholder="Enter Last Name" class="form-control" value="<?php echo $user->last_name; ?>">
                            <?php if (isset($form_error)): ?>
                    ...
                    <div class="form-group row d-flex align-items-center mb-5">
                        ...
                        <div class="col-lg-9">
                            <input type="email" name="email" placeholder="Enter Email" class="form-control" value="<?php echo $user->email; ?>">
                            <?php if (isset($form_error)): ?>
                                ...
                                <select name="user_role_id" class="custom-select form-control">
                                    ...
                                    if ($user_roles) {
                                        ...
                                        foreach ($user_roles as $role) { ?>
                                            ...
                                            <option value="<?php echo $role->id; ?>" <?php echo $role->id == $user->user_role_id ? 'selected=""' : ''; ?>><?php echo $role->title; ?>
                                            </option>
                    ...
                    <div>
                        <button class="btn btn-gradient-03" type="submit">Update User</button>
